/**
 * Shared internals. Nothing here touches the DOM at module scope, so every
 * component in this package is safe to import from a server component.
 */
 ...
 * keeps a mis-specified progress bar from rendering something nonsensical.
 */
